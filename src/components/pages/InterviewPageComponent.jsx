          ...
          <div className="hidden lg:block">
            <div className="mt-14 mb-10 flex flex-wrap justify-center gap-5">
              {["Data Analyst", "Business Analyst", "Software Engineer", "Marketing Specialist", "UI/UX Designer", "Custom Jobdesc"].map((title) => (
                <button
                  key={title}
                  className={`border border-[#F37845] rounded-full py-1 px-4 hover:bg-[#F37845] flex-grow-0 flex-shrink-0 flex-basis-0 w-52 ${
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col gap-4 justify-center text-black">
              ...
              <textarea
                ...
                cols="1"
                rows="1"
                className="w-full pb-60 p-2 rounded-3xl border-4 border-[#FA5F47] lg:h-0 lg:pb-52 lg:p-6 overflow-y-hidden"
