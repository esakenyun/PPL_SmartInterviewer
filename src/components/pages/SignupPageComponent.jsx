        ...
        <div className="flex flex-col items-center justify-center">
          <div className="text-center bg-varians-vr06 py-10 px-10 md:px-16 rounded-3xl">
            ...
            <form action="" className="flex flex-col">
              ...
              <div className="relative mt-3">
                <input className="p-2 pr-10 rounded-lg border w-full border-black text-xs" type={showConfirmPassword ? "text" : "password"} name="confirmpassword" required autoComplete="password" placeholder=" Confirm Password" />
                <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                  {showConfirmPassword ? (
              ...
              <div className="pt-4">
                <button className="py-2 bg-[#FA5F47] text-varians-vr06 font-bold w-full rounded-md hover:scale-105">Sign Up</button>
              </div>
            </form>
